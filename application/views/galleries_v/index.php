        ...
        <div class="row">
            <div class="col-12">
                <div class="cr-breadcrumb-area">
                    <h1 class="title"><?= strto("lower|upper", $languageJSON["routes"]["galeriler"]); ?></h1>
                    <ul class="breadcrumb-list">
                        ...
                        <li><span><?= strto("lower|upper", $languageJSON["routes"]["galeriler"]); ?></span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 section-title" data-aos="fade-up" data-aos-delay="300">
                <h2 class="title"><?= strto("lower|upper", $languageJSON["routes"]["galeriler"]); ?></h2>
                <span></span>
            </div>
            <!-- Section Title End -->
        </div>
                ...
                <?php if (strtotime($value->sharedAt->$lang) <= strtotime("now")) : ?>
                    <div class="col mb-10" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="feature-box-wrapper feature-box-column">
                            <div class="mb-3">
                                <a href="<?= base_url($languageJSON["routes"]["galeri"] . "/{$value->url->$lang}") ?>" title="<?= $value->title->$lang ?>">
                                    <picture>
                            ...
                            <div class="feature-content">
                                <h4 class="title"><a href="<?= base_url($languageJSON["routes"]["galeri"] . "/{$value->url->$lang}") ?>" title="<?= $value->title->$lang ?>"><?= $value->title->$lang ?></a></h4>
