        ...
        <div class="row">
            <div class="col-12">
                <div class="cr-breadcrumb-area">
                    <h1 class="title"><?= strto("lower|upper", $news->title->$lang) ?></h1>
        ...
        <div class="row mb-n9">
            <div class="col-md-5 col-lg-3 mb-8 col-sm-12">
                <div class="project-info">
                    ...
                    <ul class="mb-n1">
                        <li><span><?= $languageJSON["detailPages"]["publishDate"] ?> :</span> <?= iconv("ISO-8859-9", "UTF-8", strftime("%d %B %Y, %A %X", strtotime($news->createdAt))) ?></li>
                        <li><span><?= $languageJSON["detailPages"]["lastUpdate"] ?> :</span> <?= iconv("ISO-8859-9", "UTF-8", strftime("%d %B %Y, %A %X", strtotime($news->updatedAt))); ?></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-7 col-lg-9 col-sm-12 mb-8">
                <div class="project-desc">
                    <h4 class="title mb-6"><?= $news->title->$lang ?></h4>
                    <?= $news->content->$lang ?>
                </div>
            </div>
        </div>
