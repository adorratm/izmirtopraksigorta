        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="breadcrumb-content position-relative section-content">
                    <h3 class="title text-white"><?= strto("lower|upper", $service->title->$lang) ?></h3>
                    <ul>
                    ...
                    <div class="col-12 mb-10">
                        ...
                        <div class="blog-details mb-10">
                            ...
                            <div class="content" data-aos="fade-up" data-aos-delay="300">
                                <!-- Title -->
                                <h2 class="title mb-3"><?= $service->title->$lang ?></h2>
                                <!-- Meta -->
                                <div class="meta-list mb-3">
                                    <span class="meta-item date"><?= $languageJSON["detailPages"]["publishDate"] ?> : <?= iconv("ISO-8859-9", "UTF-8", strftime("%d %B %Y, %A %X", strtotime($service->createdAt))) ?></span>
                                    <span class="meta-item comment"><?= $languageJSON["detailPages"]["lastUpdate"] ?> : <?= iconv("ISO-8859-9", "UTF-8", strftime("%d %B %Y, %A %X", strtotime($service->updatedAt))); ?></span>
                                </div>
                                <!-- Description -->
                                <div class="desc"><?= $service->content->$lang ?></div>
                            </div>
