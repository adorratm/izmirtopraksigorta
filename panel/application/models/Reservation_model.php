...
class Reservation_model extends CI_Model
{
	...
	{
		parent::__construct();
		$this->column_order = array('rank', 'id', 'id', 'full_name','phone','email','gender','message','birthday','checkin','checkout', 'isActive','createdAt','updatedAt');
        // Set searchable column fields
        $this->column_search = array('rank', 'id', 'id', 'full_name','phone','email','gender','message','birthday','checkin','checkout', 'isActive','createdAt','updatedAt');
        // Set default order
